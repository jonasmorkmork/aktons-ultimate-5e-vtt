    ...
    renderHTML({ HTMLAttributes }) {
        return [
            ...
            mergeAttributes(HTMLAttributes, {
                'data-wiki-link': '',
                // HER ER ÆNDRINGEN: Jeg har tilføjet 'wiki-link' som den første class
                class: 'wiki-link text-amber-400 hover:text-amber-300 hover:underline cursor-pointer font-bold bg-amber-900/20 box-decoration-clone', 
            }),
            0,
        ];
    },
